...
function Sidebar() {
    ...
    const [{ user },dispatch] = useStateValue();  //this is for photo of user
    useEffect(() => {
  ...
  return (  //this src over avatar sets the photo os user as avatar
      <div className="sidebar">
          ...
          <div className="sidebar__chats">
              ...
              {rooms.map(room => (  //for every single room there is a map
                <SidebarChat key={room.id} id={room.id} name={room.data.name} /> //this name is the property that we added in the databases                         //and here return a sidebar chat component
              ))}
